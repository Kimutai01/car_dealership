defmodule CarDealership.CategoriesTest do
  use CarDealership.DataCase

  alias CarDealership.Categories

  describe "categories" do
    alias CarDealership.Categories.Category

    import CarDealership.CategoriesFixtures
    ...
    test "create_category/1 with valid data creates a category" do
      valid_attrs = %{name: "some name", logo: "some logo"}
